...
export default function FlashSale() {
  ...
  return (
    <section className="py-10">
      <div className="bg-purple-500 rounded-[2.5rem] p-6 md:p-10 text-white relative overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-end justify-between mb-8 gap-6">
          <SectionHeading
            ...
            title="Flash Sale"
            subtitle="Grab these amazing deals before they are gone forever. Exclusive discounts up to 50% off!"
          />
