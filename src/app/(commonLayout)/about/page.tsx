        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <h2 className="text-4xl font-black text-slate-900 leading-tight">Founded on Trust, Driven by Innovation</h2>
      ...
      <section className="py-32">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-20">
            <h2 className="text-4xl font-black text-slate-900 mb-6">Values that guide us</h2>
            <p className="text-slate-500 font-medium">We believe in building more than just a website; we&apos;re building a community built on shared success and integrity.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {values.map((value, i) => (
              <div key={i} className="group p-10 rounded-[3rem] bg-white border border-slate-100 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300">
                <div className={`${value.bg} w-16 h-16 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform`}>
